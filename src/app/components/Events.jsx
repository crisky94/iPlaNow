...
export default function Events() {
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--style-bg)] gap-4 flex-wrap">

            <div className="p-2 rounded-xl bg-[var(--style-cards-fancy-bg)] border border-[rgba(255,255,255,0.1)] bg-blend-normal color-dodge w-full sm:w-[300px] md:w-[350px]">
                <div className="content rounded-md">
                    ...
                    <div className="content-info mt-2 rounded-md bg-black bg-opacity-10 shadow-md py-1 backdrop-blur-[27px]">
                    ...
                    <div className="flex items-center justify-center pt-2 gap-4">
                        <button className="p-3 flex items-center justify-center w-28 gap-2 rounded-md bg-slate-600 bg-opacity-10 shadow-md border-none cursor-pointer hover:bg-slate-500 transition duration-200 backdrop-blur-[27px]">
                        ...
                        <button className="p-3 flex items-center justify-center w-28 gap-2 bg-indigo-600 shadow-md rounded-md border-none cursor-pointer hover:bg-indigo-500 transition duration-200">
            ...
            <div className="p-2 rounded-xl bg-[var(--style-cards-fancy-bg)] border border-[rgba(255,255,255,0.1)] bg-blend-normal color-dodge w-full sm:w-[300px] md:w-[350px]">
                <div className="content rounded-md">
                    ...
                    <div className="flex items-center justify-center pt-2 gap-4">
                        <button className="p-3 flex items-center justify-center w-28 gap-2 rounded-md  bg-opacity-10 shadow-md border-none cursor-pointer bg-slate-500 transition duration-200 backdrop-blur-[27px]">
                            <span className="font-medium text-white whitespace-nowrap">Info</span>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 21.5C17.2467 21.5 21.5 17.2467 21.5 12C21.5 6.7533 17.2467 2.5 12 2.5C6.7533 2.5 2.5 6.7533 2.5 12C2.5 17.2467 6.7533 21.5 12 21.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12.0053 17.2778V10.9445" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <button className="p-3 flex items-center justify-center w-28 gap-2 bg-blue-500 shadow-md rounded-md border-none cursor-pointer hover:bg-blue-600 transition duration-200">
                            <span className="font-medium text-white whitespace-nowrap">Reserve</span>
                            <span className="material-symbols-outlined">
                                calendar_add_on
                            </span>
